...
const createServer = () => {
  ...
  app.get('/hello', function (req, res) {
    res.send('Hello, and welcome to my hello route!');});
  app.get('/aboutme', function (req, res) {
    res.send('Hello. Here is a short bio about me!');});
  app.get('/favoritefoods', function (req, res) {
    res.send(['cookies', 'cake', 'popcorn']);});
  app.get('/favoritefoods', function (req, res) {
...
const count = (target,input) => {
  return input.reduce((ASF,valueWeWant) => {
    let rowCount = valueWeWant.reduce((accumulator, valueWeWant2) => {
      if (valueWeWant2 === target){
...
const totalSum = (input) => {
  return input.reduce((ASF,sumWeWant) => {
    let rowCount = sumWeWant.reduce((accumulator,sumWeWant2) => {
      return accumulator + sumWeWant2;
    },0);
    return ASF+rowCount;
  },0);
};
